...
document.querySelector('#jogador').addEventListener('click', function() {
    nomeJogador1 = prompt("Por favor, insira o nome do Jogador 1:");
    nomeJogador2 = prompt("Por favor, insira o nome do Jogador 2:");
    if (nomeJogador1 != null && nomeJogador2 != null) {
        document.getElementById("nomeJogador1").textContent = nomeJogador1;
        document.getElementById("nomeJogador2").textContent = nomeJogador2;
        var container = document.getElementById("next-player");
        var playerName = document.getElementById("player-name");
        // Defina a cor da peça do Jogador 1 como branca
        container.setAttribute("class", "occupied whitePiece");
        playerName.textContent = nomeJogador1;
    }
...
function displayCurrentPlayer() {
    ...
    if (container.classList.contains("whitePiece")) {
        ...
        playerName.textContent = nomeJogador1; // Atualize com o nome do jogador 1
    } else {
        container.setAttribute("class", "occupied whitePiece");
        playerName.textContent = nomeJogador2; // Atualize com o nome do jogador 2
    }
}
